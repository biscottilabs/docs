...
description: Learn how to swap tokens on Arc with Biscotti Finance, including pool routing, trading fees, price impact and slippage settings.
---

# Swap Tokens on Arc

Use [Biscotti Finance](https://biscotti.finance) to trade tokens on Arc.
See [Arc Mainnet setup](/arc-mainnet) to connect your wallet and
[Arc token addresses](/arc-tokens) to identify your assets. Mainnet trading
uses V3 pools; stable pools and mixed routing are also available on testnet.
