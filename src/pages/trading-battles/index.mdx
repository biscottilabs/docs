...
indexed automatically by the `trading-battles-arc` subgraph, with no registration
or opt-in transaction required.
...
and you claim directly from the contract in one transaction, trustlessly
