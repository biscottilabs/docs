...
description: How Biscotti's AMMs, router, farms, staking and incentives fit together.
---
...
Biscotti-specific `exactInputStableSwap`. This lets one transaction fan a trade
