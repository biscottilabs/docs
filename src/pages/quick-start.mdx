---
title: Arc Testnet Quick Start
description: Try Biscotti Finance on Arc Testnet. Connect a wallet, get test USDC from the faucet, swap tokens and explore liquidity and rewards.
---

# Arc Testnet Quick Start

Get from zero to your first swap on Biscotti with Arc Testnet tokens.
For mainnet trading and token launches, use the [Arc Mainnet guide](/arc-mainnet).
